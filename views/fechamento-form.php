...
<section class="mb-5">
    <div class="card my-4" id="card">
        <div id="" class="card-body pb-1">
            <div class="row mb-3">
                <div class="col-lg-2">
                    <label class="font-weight-bold">Data de Fechamento</label>
                    <input type="text" id="dt_fechamento" class="form-control" data-mascara_validacao="data">
                </div>  
                <div class="col-lg-4">
                    <label class="font-weight-bold">Selecione o Condomínio</label>
    ...
    <?php if($table) include "_cobrados.php" ?>
    <div class="row">
