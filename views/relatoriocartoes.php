...
<script src="<?php echo BASE_URL?>/assets/js/relatoriocartoes.js" type="text/javascript"></script>
            ...
            <div class="row">
                ...
                <div class="col-lg">
                    <div class="card card-body py-1 text-black text-center my-3 py-3 shadow">
                        <p class="m-0">Quantidade de Cartões</p>
                ...
                <textarea id="txt" class="d-none" ></textarea>
