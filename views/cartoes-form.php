...
<section class="mb-5">
    ...
    <div class="row my-4 d-flex">
        <div class="col-lg align-self-end">
            <label class="font-weight-bold" for="acoestxt">Ações com o Cliente</label>
            <textarea name="acoestxt" id="acoestxt" class="form-control"></textarea>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <?php endif ?>
        <?php foreach ($colunas as $key => $value): ?>
            <?php if( $value["Field"] == "acoes_cliente" ) : ?>
                <div class="col-xl-2 col-lg-3">
                    <button class="btn btn-warning btn-block" type="button" data-toggle="collapse" data-target="#acoes" aria-expanded="false" aria-controls="acoes" id="btn_acoes">Ações do Cliente</button>
                </div>
            <?php endif ?>
        <?php endforeach ?>   
    </div>
    <?php include "_historico.php" ?>
    <?php include "_acoes.php" ?>
</section>