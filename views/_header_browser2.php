...
<header class="pt-4 pb-5"> <!-- Cabeçalho -->
    <div class="row align-items-center"> <!-- Alinhar as linhas -->
        ...
        <div class="col-lg"> 
            <div class="input-group mb-3 mb-lg-0">
                <!--Input com os dados da tabela-->
                <input type="text" name="searchDataTable2" id="searchDataTable2" aria-label="Pesquise o Condomínio..." class="form-control" placeholder="Pesquise o Condomínio..." aria-describedby="search-addon">
                <!-- <div class="input-group-append">
                    <span class="input-group-text" id="search-addon">
                        <i class="fas fa-search"></i>
                    </span>
        ...
        <div class="col-lg"> 
            <div class="input-group mb-3 mb-lg-0">
                <!--Input com os dados da tabela-->
                <input type="text" name="searchDataTable3" id="searchDataTable3" aria-label="Pesquise o Assinante..." class="form-control" placeholder="Pesquise o Assinante..." aria-describedby="search-addon">
                <!-- <div class="input-group-append">
                    <span class="input-group-text" id="search-addon">
                        <i class="fas fa-search"></i>
                    </span>
